...
function HeroPhone() {
  return /* @__PURE__ */ React.createElement(PhoneFrame, null, /* @__PURE__ */ React.createElement("img", { className: "screen-photo", src: "/assets/screens/month.png?v=9", alt: "PulseCalendar \u2014 vue Mois en Liquid Glass" }));
}
const SCROLLY_STEPS = [
  {
    num: "01",
